...
def data_parse(filename):
    ...
    with open(os.path.join("assets", filename)) as f:  # Corrected path
        kat_data = f.read()
...
@pytest.mark.parametrize(
    ...
    [
        (kem, seed, param)
        for kem, filename in [
            (Kyber512, "PQCkemKAT_1632.rsp"),  # Corrected path
            (Kyber768, "PQCkemKAT_2400.rsp"),  # Corrected path
            (Kyber1024, "PQCkemKAT_3168.rsp"),  # Corrected path
        ]
